/**
 * Classes in this file should not be renamed because there has been a bug, which 
...
import org.eclipse.xtend.lib.annotation.etai.tests.extraction.intf.IExtractInterfaceSuperType

@ExtractInterface
class ExtractInterfaceNeededType extends ExtractInterfaceSuperType {
}

@TraitClassAutoUsing
abstract class ExtractInterfaceDerivedType implements IExtractInterfaceSuperType {
}
